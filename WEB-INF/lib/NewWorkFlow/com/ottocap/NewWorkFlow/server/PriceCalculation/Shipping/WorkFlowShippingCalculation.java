...
public class WorkFlowShippingCalculation
{
  private double totalprice = 0.0D;
  
  String debugstring = "";
  
  public WorkFlowShippingCalculation(ExtendOrderData myorderdata, SQLTable sqltable) throws Exception {
  ...
  public void oldCode(ExtendOrderData myorderdata, SQLTable sqltable)
    throws Exception
  {
    String shipzip = myorderdata.getCustomerInformation().getShipInformation().getZip();
    String shippingtype = myorderdata.getShippingType();
