  ...
  extends Thread
{
  ...
  public ImportOrder(List<FileItem> items, HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  private OrderData storeOrderData(OrderData orderdata) throws Exception {
    ...
    SaveOrder savedorder = new SaveOrder(orderdata, this.request.getSession(), sqltable);
    sqltable.closeSQL();
