...
import com.ottocap.NewWorkFlow.server.RPCService.JOOQ_ManageOnlineGather;
import com.ottocap.NewWorkFlow.server.RPCService.JOOQ_ManageOrders;
import com.ottocap.NewWorkFlow.server.RPCService.JOOQ_ManageSalesReport;
  ...
  extends HttpServlet
{
    ...
    throws IOException
  {
    if (request.getParameter("page").equals("salesreport")) {
      ...
      try
      {
        JOOQ_ManageSalesReport thesalesreport = new JOOQ_ManageSalesReport(loadConfig, request.getSession(), true);
      ...
      try
      {
        JOOQ_ManageOrders theorders = new JOOQ_ManageOrders(loadConfig, request.getSession(), true);
      ...
      try
      {
        JOOQ_ManageOnlineGather theorders = new JOOQ_ManageOnlineGather(loadConfig, request.getSession(), true);
