...
import com.ottocap.NewWorkFlow.server.ISampleGenerator.JOOQ_ISampleDomesticLayout;
import com.ottocap.NewWorkFlow.server.ISampleGenerator.JOOQ_ISampleOverseasLayout;
...
public class JOOQ_PDFFileHandler
{
  ...
  public Image getDomesticISampleImage(String imagekey, ExtendOrderDataItem isampledata) throws Exception {
    ...
    try {
      JOOQ_ISampleDomesticLayout mycap = new JOOQ_ISampleDomesticLayout(isampledata);
      mycap.drawImage();
  ...
  public Image getOverseasISampleImage(String imagekey, ExtendOrderDataItem isampledata) throws Exception
  {
    ...
    Image logopreview = null;
    try {
      JOOQ_ISampleOverseasLayout mycap = new JOOQ_ISampleOverseasLayout(isampledata);
      mycap.drawImage();
      if (!mycap.isEmptyImage()) {
        logopreview = Image.getInstance(mycap.getImage(), null);
      }
  ...
  public Image getDSTImage(String imagekey, ExtendOrderData orderdata, ExtendOrderDataLogo orderdatalogo, int width, int height)
    throws Exception
  {
    if (this.myimages.containsKey(imagekey)) {
      return (Image)this.myimages.get(imagekey);
  ...
  public Image getDSTImageNoConvert(String imagekey, ExtendOrderData orderdata, ExtendOrderDataLogo orderdatalogo) throws Exception
  {
    if (this.myimages.containsKey(imagekey)) {
      return (Image)this.myimages.get(imagekey);
    }
  ...
  public Image getDSTImageNoResize(String imagekey, ExtendOrderData orderdata, ExtendOrderDataLogo orderdatalogo) throws Exception
  {
    if (this.myimages.containsKey(imagekey)) {
      return (Image)this.myimages.get(imagekey);
    }
