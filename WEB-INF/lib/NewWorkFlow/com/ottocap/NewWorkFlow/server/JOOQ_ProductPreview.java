...
import com.ottocap.NewWorkFlow.server.ISampleGenerator.JOOQ_ISampleLineArtDrawer;
...
public class JOOQ_ProductPreview
  extends HttpServlet
{
    ...
    throws IOException
  {
    ...
    if (request.getParameter("ordertype").equals("Domestic"))
    {
      if (request.getParameter("sideview") != null)
      {
        ...
        try {
          JOOQ_ISampleLineArtDrawer backart = new JOOQ_ISampleLineArtDrawer(capdata, null);
      ...
      {
        JOOQ_ISampleDomesticLayout domesticlayout = new JOOQ_ISampleDomesticLayout(capdata);
        try {
    ...
    {
      JOOQ_ISampleOverseasLayout overseaslayout = new JOOQ_ISampleOverseasLayout(capdata);
      try {
