...
public class JOOQ_ISampleOverseasLayout
{
  ...
  public JOOQ_ISampleOverseasLayout(ExtendOrderDataItem capdata)
  {
  ...
  public void drawImage() throws Exception
  {
    if ((this.capdata.getStyleType() == StyleInformationData.StyleType.OVERSEAS_INSTOCK) && (this.capdata.getColorCode() != null) && (!this.capdata.getColorCode().equals(""))) {
      ...
      try
      {
        JOOQ_ISampleLineArtDrawer backart = new JOOQ_ISampleLineArtDrawer(this.capdata, ExtendOrderDataItem.SideView.BACK);
      ...
      try
      {
        JOOQ_ISampleLineArtDrawer frontart = new JOOQ_ISampleLineArtDrawer(this.capdata, ExtendOrderDataItem.SideView.FRONT);
      ...
      try {
        JOOQ_ISampleLineArtDrawer rightart = new JOOQ_ISampleLineArtDrawer(this.capdata, ExtendOrderDataItem.SideView.RIGHT);
      ...
      try {
        JOOQ_ISampleLineArtDrawer leftart = new JOOQ_ISampleLineArtDrawer(this.capdata, ExtendOrderDataItem.SideView.LEFT);
      ...
      try {
        JOOQ_ISampleLineArtDrawer insideart = new JOOQ_ISampleLineArtDrawer(this.capdata, ExtendOrderDataItem.SideView.INSIDE);
