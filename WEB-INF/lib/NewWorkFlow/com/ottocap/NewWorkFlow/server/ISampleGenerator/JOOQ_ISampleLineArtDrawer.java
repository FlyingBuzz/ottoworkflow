...
public class JOOQ_ISampleLineArtDrawer
{
  ...
  public JOOQ_ISampleLineArtDrawer(ExtendOrderDataItem capdata, ExtendOrderDataItem.SideView whichview)
    throws Exception
  {
    ...
    Record sqlrecord;
    if (((sqlrecord = JOOQSQL.getInstance().create().select(DSL.fieldByName(new String[] { "imagetype" }), DSL.fieldByName(new String[] { "Wash Type" }), DSL.fieldByName(new String[] { "Structured Type" })).from(new TableLike[] { DSL.tableByName(new String[] { "styles_overseas" }) }).where(new Condition[] { DSL.fieldByName(new String[] { "Style" }).equal(this.style) }).limit(1).fetchOne()) != null) && (sqlrecord.size() != 0)) {
      captype = ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "imagetype" }))).trim();
      this.colortype = ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "Wash Type" }))).trim();
      String currentstructure = ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "Structured Type" }))).toLowerCase();
      if (currentstructure.contains("unstructured")) {
        structuredcap = false;
      } else if (currentstructure.contains("structured")) {
        structuredcap = true;
      }
    } else if (((sqlrecord = JOOQSQL.getInstance().create().select(DSL.fieldByName(new String[] { "category" })).from(new TableLike[] { DSL.tableByName(new String[] { "styles_domestic_shirts" }) }).where(new Condition[] { DSL.fieldByName(new String[] { "sku" }).equal(this.style) }).limit(1).fetchOne()) != null) && (sqlrecord.size() != 0)) {
      captype = ((String)sqlrecord.getValue(DSL.fieldByName(tmp690_687))).trim().equals("T-Shirt") ? "tshirt" : "sportsshirt";
    } else if (((sqlrecord = JOOQSQL.getInstance().create().select(DSL.fieldByName(new String[] { "category" })).from(new TableLike[] { DSL.tableByName(new String[] { "styles_domestic_sweatshirts" }) }).where(new Condition[] { DSL.fieldByName(new String[] { "sku" }).equal(this.style) }).limit(1).fetchOne()) != null) && (sqlrecord.size() != 0)) {
      captype = "sweatshirt";
    } else if (((sqlrecord = JOOQSQL.getInstance().create().select(DSL.fieldByName(new String[] { "imagetype" }), DSL.fieldByName(new String[] { "Wash Type" })).from(new TableLike[] { DSL.tableByName(new String[] { "styles_overseasinstock" }) }).where(new Condition[] { DSL.fieldByName(new String[] { "STYLE NUMBER" }).equal(this.style) }).limit(1).fetchOne()) != null) && (sqlrecord.size() != 0)) {
      captype = ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "imagetype" }))).trim();
      this.colortype = ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "Wash Type" }))).trim();
    } else if (((sqlrecord = JOOQSQL.getInstance().create().select(DSL.fieldByName(new String[] { "Style" })).from(new TableLike[] { DSL.tableByName(new String[] { "styles_overseas_customstyle" }) }).where(new Condition[] { DSL.fieldByName(new String[] { "Style" }).equal(this.style) }).limit(1).fetchOne()) != null) && (sqlrecord.size() != 0))
    {
    ...
    if (((sqlrecord = JOOQSQL.getInstance().create().select(DSL.fieldByName(new String[] { "description2" })).from(new TableLike[] { DSL.tableByName(new String[] { "styles_domestic" }) }).where(new Condition[] { DSL.fieldByName(new String[] { "sku" }).equal(this.style) }).limit(1).fetchOne()) != null) && (sqlrecord.size() != 0)) {
      String currentstructure = ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "description2" }))).toLowerCase();
      if (currentstructure.contains("unstructured")) {
        structuredcap = false;
      } else if (currentstructure.contains("structured")) {
        structuredcap = true;
    ...
    if ((sideview == ExtendOrderDataItem.SideView.INSIDE) && (structuredcap)) {
    ...
    throws Exception
  {
    ...
    Record sqlrecord;
    if (((sqlrecord = JOOQSQL.getInstance().create().selectFrom(DSL.tableByName(new String[] { "list_overseas_work_structure" })).where(new Condition[] { DSL.fieldByName(new String[] { "id" }).equal(structure) }).and(DSL.fieldByName(new String[] { "name" }).contains("washed")).limit(1).fetchOne()) != null) && (sqlrecord.size() != 0)) {
    ...
    if (((sqlrecord = JOOQSQL.getInstance().create().selectFrom(DSL.tableByName(new String[] { "thread_ottocolors" })).where(new Condition[] { DSL.fieldByName(new String[] { "code" }).equal(code) }).limit(1).fetchOne()) != null) && (sqlrecord.size() != 0)) {
      if (this.colortype.equals("Garment Washed")) {
        String thecolor = ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "washedcolor" }))).trim();
        if (!thecolor.equals("")) {
          return thecolor;
        }
        return ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "colorvalue" }))).trim();
      }
      if (this.colortype.equals("Washed Pigment Dyed")) {
        String thecolor = ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "pigmentdyed" }))).trim();
        if (!thecolor.equals("")) {
          return thecolor;
        }
        return ((String)sqlrecord.getValue(DSL.fieldByName(new String[] { "colorvalue" }))).trim();
