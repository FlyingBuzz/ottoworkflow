  ...
  extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      GetOrder myorder = new GetOrder(Integer.valueOf(request.getParameter("hiddenkey")).intValue(), request.getSession(), sqltable);
      ...
      if (request.getParameter("managetype") != null) {
        if (request.getParameter("managetype").equals("NEWQUOTESORDERS")) {
          if (orderdata.getOrderStatus().equals("New Quotation")) {
            ...
            new SaveOrder(orderdata, request.getSession(), sqltable);
